...
bool Window::init(HINSTANCE h_instance, int show_wnd, int width, int height, bool windowed)
{
	...
	m_h_app_wnd = CreateWindowEx(NULL, m_wnd_class_name, "The height map is a picture of Waluigi!", WS_OVERLAPPEDWINDOW, x, y, width, height, NULL, NULL, h_instance, NULL);
	if (!m_h_app_wnd)
	{
