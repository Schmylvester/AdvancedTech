...
private:
	float checkProjectionIntersect(Vector3 a_pos, Vector3 b_pos, Vector3 a_size, Vector3 b_size, Vector3 a_x_proj, Vector3 a_y_proj, Vector3 a_z_proj, Vector3 b_x_proj, Vector3 b_y_proj, Vector3 b_z_proj, Vector3 projection);
